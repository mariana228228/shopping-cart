  ...
  render() {
    return (
      <div id="cart">
        ...
        <RiShoppingCart2Fill onClick={this.showOverlay}/>
    ...
    return (
      ...
      <div id="overlay">
        <section id="shopping-cart">
          ...
          <button id="checkout" 
            disabled={itemsInCart.length == 0 ? true : false} onClick={this.openBuyCard}>Checkout</button>
        </section>
      </div>

      <div id='buyForm'>
        <section id='section_buy_card'> 
        <div className='buying_card'>
       <span>name:   <input type='text' placeholder="введіть ім'я"></input></span> <br/>
       <span>email:   <input type='text' placeholder="введіть email"></input></span>
...
class ShopingCardBuy extends React.Component{
  constructor(props){
    super()
  }
  render() {
    return(
      <div className='buyForm'></div>
    )
  }
}
  ...
  render() {
    return(
      <tr className="items-in-cart">
        ...
        <td><ImBin2
              onClick={this.handleRemoveFromCart}/></td>
      </tr>
    )
  }
}
